...
public class Test {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// Da su atributi namirnice i pice javni, mogli bismo im na ovaj nacin zadati vrednosti
		// Medjutim, da bi sprecili unos greske, pristup cemo im oznaciti privatnim i koristiti getere i setere
		/*
